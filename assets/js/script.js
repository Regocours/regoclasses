...
//Stash the instructions so they can be redisplayed
	alert('Quelques règles de ce Quiz.' 
 +'\n' + '1. Vous n\'aurez que 3 minutes pour chaque question.'
 +'\n' + '2. Le quiz compte 10 questions. Résolvez votre question avant de valider'
 + '\n' + '3. Vous avez un crédit de 30 min pour tout résoudre .' 
 + '\n' + '4. Lorsque vous avez validé une question cliquer suivant pour continuer .' 
 + '\n' + '5. A la fin vous êtes noté automatiquement en pourcentage.'
 + '\n' + '6. Si vous faites 100% avant le temps , une boîte de dialogue vous invitera à imprimer.' 
 + '\n' + '7. Si vous ne faites pas 100% et que vous avez validé toutes les questions avant le temps imparti ,attendez la fin du temps pour que la boîte de dialogue vous invite à imprimer.'
 + '\n' + '8.Suivez les instructions puis Cliquer Imprimer pour enregistrer votre résultat en fichier pdf.'
 + '\n' + '9.Arès avoir enregistré , la question suivante apparaîtra et Cliquer sur Next Question pour continuer'
 + '\n' + '10.Gare à vous ,l\'application détecte la tricherie.' );
...
var dateTime ='à'+ ' ' + time+' '+  'le ' + date;

document.getElementById("ShowMeIndextop").innerHTML ='Début ::' + ' ' + dateTime;
document.getElementById('ShowMeIndextop').style.color = "white";
document.getElementById('ShowMeIndextop').style.display = 'inline';
}
